...
<div class="space-y-6 py-6">
    ...
    <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = ['#laravel', '#vuejs', '#react', '#tailwindcss', '#javascript']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="#" class="block px-3 py-2 bg-gray-50 hover:bg-gray-100 rounded-lg transition">
                    <div class="font-medium text-gray-800"><?php echo e($topic); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e(rand(100, 1000)); ?> posts</div>
                </a>
