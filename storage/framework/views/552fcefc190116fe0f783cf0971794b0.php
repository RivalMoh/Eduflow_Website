        ...
        <div class="flex space-x-3 overflow-x-auto pb-3 -mx-1 px-1" style="scrollbar-width: thin;">
            <button class="flex-shrink-0 w-32 bg-white rounded-lg p-3 shadow-xs border border-gray-100 hover:shadow-sm transition-shadow">
                ...
                <div class="w-6 h-6 rounded bg-gray-200 flex-shrink-0 overflow-hidden">
                        <img 
                            src="<?php echo e(asset('images/icons/number_theory.png')); ?>" 
                            alt="Room" 
            ...
            <button class="flex-shrink-0 w-32 bg-white rounded-lg p-3 shadow-xs border border-gray-100 hover:shadow-sm transition-shadow">
                <div class="flex items-center space-x-2">
                    <div class="w-6 h-6 rounded bg-gray-200 flex-shrink-0 overflow-hidden">
                        <img 
                            src="<?php echo e(asset('images/icons/game.png')); ?>" 
                            alt="Room" 
                            class="w-full h-full object-cover"
                            style="width: 24px; height: 24px; object-fit: contain;"
                        >
                    ...
                    <div class="min-w-0">
                        <h4 class="text-xs font-medium text-gray-900 truncate">Room <?php echo e($i); ?></h4>
                    </div>
                </div>
            </button>
            <?php endfor; ?>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-medium">
                                <?php if($post->user): ?>
                                    <?php echo e(strtoupper(substr($post->user->name ?? $post->user->username ?? 'U', 0, 1))); ?>
                            ...
                            <div>
                                <h4 class="font-medium text-gray-900">
                                    <?php if($post->user): ?>
                                        <?php echo e($post->user->name ?? $post->user->username ?? 'Unknown User'); ?>
